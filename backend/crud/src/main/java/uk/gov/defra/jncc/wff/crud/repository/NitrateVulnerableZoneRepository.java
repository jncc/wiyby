 ...
 * @author felix
 */
public interface NitrateVulnerableZoneRepository extends Repository <NitrateVulnerableZone, Serializable>, QueryDslPredicateExecutor<NitrateVulnerableZone>  {
