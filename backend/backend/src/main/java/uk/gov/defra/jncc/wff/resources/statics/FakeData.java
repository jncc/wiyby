...
public class FakeData {
    ...
    public static Iterable<AttributedZone> case1() {
        return Collections.unmodifiableList(Stream.of(
                NVZ
        ).collect(Collectors.toList()));
    }

    public static Iterable<AttributedZone> case2() {
        return Collections.unmodifiableList(Stream.of(
                NVZ,
                SGZ_GW_1,
                SGZ_SW_1
    ...
    public static Iterable<AttributedZone> case3() {
        return Collections.unmodifiableList(Stream.of(
                SGZ_SW_1,
                SGZ_SW_2,
                SGZ_SW_3
    ...
    public static Iterable<AttributedZone> case4() {
        return Collections.unmodifiableList(Stream.of(
                SGZ_GW_2,
                SGZ_SW_3
        ).collect(Collectors.toList()));
    ...
    public static Iterable<AttributedZone> case5() {
